...
// smaller, larger, sum, difference, product, ratio between two integers - nope, DOUBLES

int main() {
	cout << "\nSo let me tell you about two numbers. Enter two floating-point numbers, seperated by a whitespace, now.\n";
	double val1;
	double val2;
	double larger;
	double smaller;
